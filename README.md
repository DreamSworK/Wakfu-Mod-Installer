...
## Wakfu Mods:
Пользовательские модификации, которые автоматически загружаются из папки **mods** при запуске. В данный момент доступен для скачивания только один мод *"Руссификация Wakfu"*, созданный на основе проекта https://github.com/Valianton/Wakfu-Translate
